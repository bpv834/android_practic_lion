...
//    }
    ...
    // RecyclerView의 어뎁터
    inner class RecyclerShowMemoAdapter :
        RecyclerView.Adapter<RecyclerShowMemoAdapter.ViewHolderMemoAdapter>() {
        // ViewHolder
        inner class ViewHolderMemoAdapter(val rowMemoBinding: RowMemoBinding) :
            ...
            rowMemoBinding.buttonRowFavorite.setOnClickListener {
                ...
                CoroutineScope(Dispatchers.Main).launch {
                    ...
                    if (arguments?.getString("MemoName") == MemoListName.MEMO_NAME_FAVORITE.str) {
                        ...
                        fragmentShowMemoAllBinding.recyclerViewShowMemoAll.adapter?.notifyItemRemoved(
                            viewHolderMemoAdapter.adapterPosition
                        )
                    } else {
        ...
        override fun onBindViewHolder(holder: ViewHolderMemoAdapter, position: Int) {
            if (memoList[position].memoIsSecret) {
                ...
                holder.rowMemoBinding.textViewRowTitle.setTextColor(Color.DKGRAY)
            } else {
